...
- Provider baseUrl: `http://127.0.0.1:7782`
- Shadow mode: `false`
- Min confidence: `0.6`
...
- Divergence from deterministic: **20**
...
| Q108 | GENERAL | WHEN | GENERAL | GENERAL | 1.000 | http_classifier |  |
| C001 | GENERAL | WHEN | GENERAL | GENERAL | 1.000 | http_classifier |  |
| C003 | GENERAL | WHEN | GENERAL | GENERAL | 0.994 | http_classifier |  |
| C011 | WHEN | GENERAL | WHEN | WHEN | 0.998 | http_classifier |  |
| C017 | WHEN | WHEN | GENERAL | WHEN | 0.635 | deterministic | low_confidence |
| C021 | WHEN | GENERAL | WHEN | WHEN | 0.992 | http_classifier |  |
...
| CR-TIE003 | GENERAL | WHEN | GENERAL | GENERAL | 1.000 | http_classifier |  |
| CR-TIE004 | GENERAL | ENTITY | GENERAL | GENERAL | 1.000 | http_classifier |  |
