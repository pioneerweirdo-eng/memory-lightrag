...
- Shadow mode: `false`
- Min confidence: `0.6`
- Min confidence by intent: `{"ENTITY":0.45}`
- Min margin by intent: `{"ENTITY":0.1}`
...
| Intent | Precision | Recall | Hit | Miss | Support |
|---|---:|---:|---:|---:|---:|
| WHY | 100.00% | 91.67% | 22 | 2 | 24 |
| WHEN | 83.33% | 93.75% | 30 | 2 | 32 |
| ENTITY | 81.08% | 100.00% | 30 | 0 | 30 |
...
- Model accuracy when available: **71.25%**
- Selected from model count: **95**
- Fallback count: **65**
...
| Q048 | WHY | WHY | ENTITY | ENTITY | 0.451 | python_stdio |  |
...
| Q022 | WHEN | WHEN | ENTITY | ENTITY | 0.456 | python_stdio |  |
