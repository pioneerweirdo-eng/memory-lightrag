# Memory Semantics Audit - 2026-04-05
...
- Ranked IDs: ep_when_noise, ep_when_recent
- Ranked lanes: episodic, episodic
- Selected IDs: ep_when_noise
- Selected lanes: episodic
- Top group dominant anchor: ep_when_noise
- Top group value: When did Caroline meet the counselor? She kept asking that exact question.
- Answer: 1 March 2026
- Answer mode/support: temporal/temporal_or_derived

### Top Ranked Breakdown

- Ranked[1] ep_when_noise (episodic) | rank=0.9574 confidence=0.5769 group=0.8189 lexical=0.6763 semantic=0.0000 support=0.4956 temporal=0.7000
- Ranked[2] ep_when_recent (episodic) | rank=0.9358 confidence=0.4436 group=0.8037 lexical=0.5173 semantic=0.0000 support=0.4956 temporal=0.7000

- GAP - Top ranked anchor is the recent event | expected: ep_when_recent | actual: ep_when_noise
- GAP - Selected anchor keeps the recent event | expected: ep_when_recent | actual: ep_when_noise
- GAP - Rendered answer stays temporal | expected: temporal answer mentioning 2026-04-05 | actual: 1 March 2026
...
- Status: GAP
- Summary: 0/3 checks passed
- Ranked IDs: ep_identity_generic, session_1_summary_identity
- Ranked lanes: episodic, semantic_summary
- Selected IDs: ep_identity_generic
- Selected lanes: episodic
- Top group dominant anchor: ep_identity_generic
- Top group value: Caroline talked with a friend about different life updates.
- Answer: Caroline talked with a friend about different life updates.
- Answer mode/support: direct/lexically_supported

### Top Ranked Breakdown

- Ranked[1] ep_identity_generic (episodic) | rank=0.7782 confidence=0.4169 group=0.6934 lexical=0.2016 semantic=0.0000 support=0.4956 temporal=0.9897
- Ranked[2] session_1_summary_identity (semantic_summary) | rank=0.7156 confidence=0.4169 group=0.6496 lexical=0.2613 semantic=0.0000 support=0.4956 temporal=0.9883

- GAP - Top ranked anchor is the semantic summary | expected: session_1_summary_identity | actual: ep_identity_generic
- GAP - Top selected anchor is still the semantic summary | expected: session_1_summary_identity | actual: ep_identity_generic
- GAP - User-facing answer retains the identity fact | expected: answer contains transgender woman | actual: Caroline talked with a friend about different life updates.
